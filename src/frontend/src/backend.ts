...
export class Backend implements backendInterface {
    ...
    async getFeaturedTracks(arg0: bigint): Promise<Array<Track>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFeaturedTracks(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchTracks(arg0: string): Promise<Array<Track>> {
        if (this.processError) {
            try {
